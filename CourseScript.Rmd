...
* two ways of completing the course:
-- start with theory if you prefer 
-- start with case study lecture if you prefer start exploring possibilities and want to solve this problems quick (get the solution and start using it)

Assess your situation:
A. Beginner -> proceed slowly
B. Advanced & want to get things done quick -> Disclamer -> Lecture "Summary Encryption Process in 5 minutes" -> Pick up desired solution for your use
C. Expert -> All steps from B & adapt and extend desired solution

#### Lecture 3 Disclamer

By joining this course or using material from the course you agree that all materials of the course are solely provided "as is" without any guarantee of functionality. All methods are provided for training purposes. Course developed by non security expert by explaining the practical use of OpenSSL software library in R Statistical Language. There is a risk that you can loose your information in case you are not properly follow the instructions or by loosing your private key or alike. Make sure you know what you do at any time when using the material of the course. Always test your knowledge on dummy data before applying it to real data... Memory areas for your private key, secrets, or passphrase are not securely cleaned after use. You are using the material of the course at your own risk!
...
Hello Thank you for continuing the course. In this lecture I would give you some intuitive understanding on Cryptography. I am not going to overcomplicate things. I would like to stress the fact that I am not a security expert. My goal is to let you easily use cryptography to your advantage. I believe you should just know **WHAT** this process is all about and to know **HOW** to use it. 
...
This lecture will be containing 3 parts:

* History and application in industry
* Paradox of Cryptography
* Possible future

My goal of this lecture is to spark more curiosity in your understanding about cryptography

Let me just very briefly discuss on this fascinating subject... in easy and digestable way

##### History and application in industry

From Wikipedia "Cryptography or cryptology (from Greek κρυπτός kryptós, "hidden, secret"; and γράφειν graphein, "writing", or -λογία -logia, "study", respectively[1]) is the practice and study of techniques for secure communication in the presence of third parties called adversaries.[2] More generally, cryptography is about constructing and analyzing protocols that prevent third parties or the public from reading private messages". 

I would list critical elements of the thing:

* Secret owner and exchanging party -  Group of people that need to privately exchange secret
* Secret itself - piece of secret information
* Adversary - person that is looking to obtain secret information
* Communication protocol - specific method of transforming information from/to decrypted/encrypted state (usually known to restricted group of persons or sometimes public)
* Encrypted information - piece of information 
* Key to use communication protocol - specific key required to encrypt information

I prefer more simple example: 

I need to communicate to my friend xiao one simple message: "Let us go for a coffee to the bar..." I am in the office and all my colleagues are there as well. I don't want them to know what is our plan.

Me and Xiao are knowing chinese so I would write this message to Xiao in Chinese... "讓我們去吧台喝咖啡吧"

That's it! Here only me and Xiao knowing to decrypt this message, others not! Well, they may still but this would require them to crack our code!!!

Please pause the video for a second and think where are the critical elements of Cryptography in this case!!!

Cryptography may be more simple. You can just agree with Xiao beforehand about special key words that will have double meaning. For example you can agree together that once you say "weekend" and "forest" together these words would mean "cofee" and "bar" respectively. So you could just simply mention in the free talk to Xiao something like: "Oh this weekend it's going to be a very sunny day. It would be great to spend some time to hike in "Forest"... Others will think that you are just talking about weekend. They will not immediately guess anything if you and then Xiao will leave the office to go to the bar and getting coffee... They may still guess something if you will repeat this trick several time in the week, right?

This method may be used when you need to communicate without exposing fact that you are actually encrypting the message!!! once again pause the video and think what are the key elements of Cryptography in this example!!!???
