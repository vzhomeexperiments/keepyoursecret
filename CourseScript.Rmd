...
Do you feel overwhelmed with number of passwords that you need to remember? Does anybody told you that your password should contain at least one number one character as a capital letter, one special character and be necessarily 15 characters long? Someone told you to never recycle your passwords, but you must also replace them every 3 months???

I have the same problem and for me the only solution is Cryptography...

And this course is just about that. 

You will learn how to use Open Source and Free R Statistical Software to be able to encrypt and decrypt your information using Public Key Cryptography. 
You will learn how to create your own Private and Public Keys. 
You will be able to exactly follow steps that are required to encrypt/decrypt send store your information.
Even collaborate online using GitHub and securely keeping user credentials in a team. 
I will cover the part related to encryption of passwords in your R-Server applications such as ShinyApp.
Of course you may ask me what is that special thing that in that course?! Why not just use ready to use solutions for cryptography? Why we should take this course? 

I believe this course is providing a value in three dimensions: open, practical, transparent
...
Quite funny but I have build this course because I wanted to take advantage of Cryptography!!! I did a research and now I can easily keep my secrets under control

WIth that said I would welcome you to enjoy this course about such a fascinating topic!!! See you in the class!!!
...
B. Losing a copy of Private Key. Risk may materialize when you keep your key in Laptop that is stolen or broken. Always keep at least one copy of Private Key in a secure place. For example keep a copy of Private Key on your USB Key. Regularly review your Keys and update them all at once. Remember to Decrypt your Encrypted information before you delete your old Private Key

C. Loosing a password to your Private Key File. When you write your private key to a file and setting a password you may forget it. Make sure you remember this password. You may want to choose to keep a copy of Private Key if you are not sure.

D. Loosing encrypted information. You may be loosing control over encrypted information. For example, you can simply forget where it is stored and with which key it was encrypted. In order to minimize this risk you should create solid storage system with specific rules and regularly review (use) the data you encrypt. Do not hesitate to keep a copy of encrypted information in the cloud storage such as OneDrive or Google Drive, etc. Remember to decrypt all encrypted information when you exchange your Private Key
...
G. Render your passphrase or event also your private keys public. Make sure you don't 'commit' private key to a public repository when using Version Control. Do not store .History file inside the commits. Always delete content of the History and Console

H. Memory areas of computer storing the key are not securely cleaned after use. In order to securely clean your data you need to write new information to the memory, delete it and perform this process several times. This is out of scope of this course
...
Hello and welcome back to the Case Studies section of this course. In this lecture we will look on one use case of **public key cryptography** for developing things in **R**. In particular, how would you deal with projects that require to access data storage? In case you would need to use passwords to access data and at the same time you can not store those passwords in the public accounts on GitHub! However there is a solution! It's developed by Gabor Gsardi and can be used using R package 'secret'

The basic idea is to simply encrypt part of your R project. Both you and your colleagues can decrypt this information using their private keys.

Let's see how is this implemented:
...
You did that! Do you feel now satisfied because now you can do new and powerful things? Are you inspired to apply your new knowledge for your projects??? Then I am sure that you did a great job and put enough effort to learn in this course.

I would love to get connected with you via Linkedin or even through the simple message on Udemy. Feel free to share your achievements inspired by this course!!!

The main takaway for this course for me is that Keeping secrets is quite demanding. I hope this course helped you with that and now you capable to put this under control!!!
