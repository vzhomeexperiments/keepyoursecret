...
On Mac executable files are also named 'bash' scripts. It is a kind of a way to get more direct assess to the Operating System and program installed on it. To try it out you can open 'Terminal' on mac to execute some code.
...
in my case, the path is: /usr/local/bin/Rscript
