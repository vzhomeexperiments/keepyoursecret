...
This little experiment will be dedicated to understanding how long will it take to encrypt information if we change two variables:

* if we use larger dataset
* if we use longer key
...
library(tidyverse)
# import
ConsumerComplaints <- read_csv("~/6_CoursesUdemy/05_Keepyoursecret/keepyoursecret/ConsumerComplaints.csv")
# view dimensions
...
Just test function first...

```{r}
# seems to be very fast!
res <- Encrypt_Decrypt(ConsumerComplaints_quart, key_2)
```
