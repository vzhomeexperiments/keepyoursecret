...
```
    ...
    ##   ..$ type       : chr "rsa"
    ##   ..$ size       : int 2099
    ##   ..$ ssh        : chr "ssh-rsa AAAAB3NzaC1yc2EAAAADAQABAAABBwZuqf03i ..."
    ##   ..$ fingerprint:Classes 'hash', 'md5'  raw [1:16] bd 85 eb db ...
    ##   ..$ data       :List of 2
    ##   .. ..$ e:Class 'bignum'  raw [1:3] 01 00 01
    ##   .. ..$ n:Class 'bignum'  raw [1:263] 06 6e a9 fd ...
    ##  $ data  :List of 8
    ##   ..$ e :Class 'bignum'  raw [1:3] 01 00 01
    ##   ..$ n :Class 'bignum'  raw [1:263] 06 6e a9 fd ...
    ##   ..$ p :Class 'bignum'  raw [1:132] 03 85 dd 03 ...
    ##   ..$ q :Class 'bignum'  raw [1:132] 01 d3 6a ac ...
    ##   ..$ d :Class 'bignum'  raw [1:263] 03 53 5c 18 ...
    ##   ..$ dp:Class 'bignum'  raw [1:131] 53 1a 7d 9e ...
    ##   ..$ dq:Class 'bignum'  raw [1:131] 4a 92 c2 76 ...
    ##   ..$ qi:Class 'bignum'  raw [1:132] 01 10 77 cb ...
...
```
    ...
    ## List of 3
    ##  $ iv     : raw [1:16] 16 a7 2e 3a ...
    ##  $ session: raw [1:263] 00 43 59 52 ...
    ##  $ data   : raw [1:48] b8 c3 46 0a ...
