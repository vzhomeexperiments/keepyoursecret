...
tags: openssl tidyverse cryptography
---
...
```
    ...
    ##   ..$ type       : chr "rsa"
    ##   ..$ size       : int 2099
    ##   ..$ ssh        : chr "ssh-rsa AAAAB3NzaC1yc2EAAAADAQABAAABBwVSDzJC3 ..."
    ##   ..$ fingerprint:Classes 'hash', 'md5'  raw [1:16] f3 c7 21 11 ...
    ##   ..$ data       :List of 2
    ##   .. ..$ e:Class 'bignum'  raw [1:3] 01 00 01
    ##   .. ..$ n:Class 'bignum'  raw [1:263] 05 52 0f 32 ...
    ##  $ data  :List of 8
    ##   ..$ e :Class 'bignum'  raw [1:3] 01 00 01
    ##   ..$ n :Class 'bignum'  raw [1:263] 05 52 0f 32 ...
    ##   ..$ p :Class 'bignum'  raw [1:132] 03 55 81 17 ...
    ##   ..$ q :Class 'bignum'  raw [1:132] 01 98 89 35 ...
    ##   ..$ d :Class 'bignum'  raw [1:263] 05 1e 84 72 ...
    ##   ..$ dp:Class 'bignum'  raw [1:132] 02 47 6d a2 ...
    ##   ..$ dq:Class 'bignum'  raw [1:132] 01 1d 9b a7 ...
    ##   ..$ qi:Class 'bignum'  raw [1:131] 6a cf d6 8b ...
...
```
    ...
    ## List of 3
    ##  $ iv     : raw [1:16] 08 8d 6f 27 ...
    ##  $ session: raw [1:263] 02 cc 64 f9 ...
    ##  $ data   : raw [1:48] 88 23 25 c3 ...
