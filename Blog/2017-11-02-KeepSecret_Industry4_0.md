...
```
    ...
    ##   ..$ type       : chr "rsa"
    ##   ..$ size       : int 2099
    ##   ..$ ssh        : chr "ssh-rsa AAAAB3NzaC1yc2EAAAADAQABAAABBwYk6z/wt ..."
    ##   ..$ fingerprint:Classes 'hash', 'md5'  raw [1:16] a6 63 4e 5b ...
    ##   ..$ data       :List of 2
    ##   .. ..$ e:Class 'bignum'  raw [1:3] 01 00 01
    ##   .. ..$ n:Class 'bignum'  raw [1:263] 06 24 eb 3f ...
    ##  $ data  :List of 8
    ##   ..$ e :Class 'bignum'  raw [1:3] 01 00 01
    ##   ..$ n :Class 'bignum'  raw [1:263] 06 24 eb 3f ...
    ##   ..$ p :Class 'bignum'  raw [1:132] 03 a3 b9 3f ...
    ##   ..$ q :Class 'bignum'  raw [1:132] 01 b0 2c b0 ...
    ##   ..$ d :Class 'bignum'  raw [1:263] 04 26 24 11 ...
    ##   ..$ dp:Class 'bignum'  raw [1:132] 01 97 aa 5f ...
    ##   ..$ dq:Class 'bignum'  raw [1:132] 01 88 13 02 ...
    ##   ..$ qi:Class 'bignum'  raw [1:132] 02 49 06 ce ...
...
```
    ...
    ## List of 3
    ##  $ iv     : raw [1:16] 78 86 9a 9c ...
    ##  $ session: raw [1:263] 05 55 7b 3e ...
    ##  $ data   : raw [1:48] a8 ac ed f2 ...
