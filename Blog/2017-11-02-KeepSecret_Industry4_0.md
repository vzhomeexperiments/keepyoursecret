...
```
    ...
    ##   ..$ type       : chr "rsa"
    ##   ..$ size       : int 2099
    ##   ..$ ssh        : chr "ssh-rsa AAAAB3NzaC1yc2EAAAADAQABAAABBwWIVoE+D ..."
    ##   ..$ fingerprint:Classes 'hash', 'md5'  raw [1:16] 0b 1f 1d b6 ...
    ##   ..$ data       :List of 2
    ##   .. ..$ e:Class 'bignum'  raw [1:3] 01 00 01
    ##   .. ..$ n:Class 'bignum'  raw [1:263] 05 88 56 81 ...
    ##  $ data  :List of 8
    ##   ..$ e :Class 'bignum'  raw [1:3] 01 00 01
    ##   ..$ n :Class 'bignum'  raw [1:263] 05 88 56 81 ...
    ##   ..$ p :Class 'bignum'  raw [1:132] 03 9a dd d0 ...
    ##   ..$ q :Class 'bignum'  raw [1:132] 01 88 e3 25 ...
    ##   ..$ d :Class 'bignum'  raw [1:263] 02 d3 0c 5e ...
    ##   ..$ dp:Class 'bignum'  raw [1:132] 02 fb 4b 2c ...
    ##   ..$ dq:Class 'bignum'  raw [1:132] 00 f1 fb dd ...
    ##   ..$ qi:Class 'bignum'  raw [1:132] 01 e1 d7 9e ...
...
```
    ...
    ## List of 3
    ##  $ iv     : raw [1:16] cf 56 02 17 ...
    ##  $ session: raw [1:263] 00 ae 89 31 ...
    ##  $ data   : raw [1:48] 23 13 ed bb ...
