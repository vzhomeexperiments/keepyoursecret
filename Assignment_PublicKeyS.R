...
hash <- private_key$pubkey$fingerprint
# this is alternative way to extract elements of the list
hash <- private_key[["pubkey"]][["fingerprint"]]
...
# warning: this line below will clean all elements from Environment
remove(list = ls())
