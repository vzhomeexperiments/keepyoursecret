...
This lecture will be dedicated to achieve simple goal: "How to avoid keeping password in our scripts we checking in to the Version Control Repositories". This lecture also compliment previous lecture about using Public Version control repository. In fact if you use package `secret` then you should be already fine. This lecture is only useful if you don't plan to collaborate and just want to avoid exposing password in your code directly using `openssl`

#### Scenario

Usually in your R script or shiny App you may have a function that contact SQL server or alike. This function may need user credentials such as *User Name* and *Passwords*. In this lecture we will expose one way avoiding this by encrypting your password in your project and keeping your private key inside of your Server File System.
...
You don't want to keep this code in your Version Control Repository or even in your Documentation!!!
...
Finally we can retrieve our key
