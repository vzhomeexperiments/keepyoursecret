...
In order to achieve our goal will be using package 'secret' in R to keep part of R project encrypted.
...
for that our learning objectives for this lecture will be:

* we will get the main idea on the usage
* simulate the practical use
